...
!function (e) {
    ...
    if ("undefined" != typeof e) {
        ...
        return t.firstUpperCase = t.ucfirst = a, t.urls = {atLinkBase: "https://github.com/"}, t.regexs = {
            ...
            }, r.href = application+"/"+e + ".css", "head" === o ? document.getElementsByTagName("head")[0].appendChild(r) : document.body.appendChild(r)
            ...
            var r = null;
            r = document.createElement("script"), r.id = e.replace(/[\./]+/g, "-"), r.type = "text/javascript", r.src =application+"/"+ e + ".js", t.isIE8 ? r.onreadystatechange = function () {
