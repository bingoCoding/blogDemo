...
$(function () {
    ...
    mdEditor = editormd("markdown-editor", {
        ...
        a.action = application+"/admin/post.action", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
    }), $("#update-blog").bind("click", function () {
        var a = document.forms[0];
        a.action = application+"/admin/update.action", a.method = "post", document.blogForm.article.value = $(".markdown-body")[0].innerHTML, document.blogForm.md.value = mdEditor.getMarkdown(), a.submit()
    }), $("#update-resume").bind("click", function () {
        var a = document.forms[0];
        a.action = application+"/admin/resume.action", a.method = "post", document.resumeForm.resume.value = $(".markdown-body")[0].innerHTML, document.resumeForm.md.value = mdEditor.getMarkdown(), a.submit()
    })
});